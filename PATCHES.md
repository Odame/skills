...
| [`productivity/design-prompt-writer`](./skills/productivity/design-prompt-writer/SKILL.md)         | New skill, no upstream counterpart.                                                                                                                             | Turns a brand, brief, audience, references and creative standards into a foundation prompt for a new Claude Design project. Interviews for facts only; perceptual choices (color, typeface, layout) are left to Claude Design's own visual interview rather than asked for in words.                                                                                        |
