...
- Lint: `uv run ruff check plugins/plain-english-checker`
- Format check: `uv run ruff format --check plugins/plain-english-checker`
- Test: `uv run pytest plugins/plain-english-checker`
- Test a single test: `uv run pytest plugins/plain-english-checker/tests/test_file.py::test_name`
