...
- **[design-prompt-writer](./design-prompt-writer/SKILL.md)**: Turn a brand, brief, audience, references, and creative standards into a foundation prompt for a new Claude Design project.
